...
- [Provenant](https://github.com/mblauberg/provenant): portable equal-primary
  agent harness for Claude and Codex. Skills, review gates and an agent fabric
...
- GlassChain: read-only blockchain wallet intelligence system from UQ's
  ...
  private repo.)
- Nova Edge: underwater glider simulator in Unreal Engine (C++), built for
  Flying Fish Technologies. I built the physics systems: hydrodynamics,
  PID-controlled attitude and spring-damper cable towing. (Team project,
  private repo.)
...
I recently completed my honours thesis on ML-based scam detection. The work is
private for now.

[LinkedIn](https://www.linkedin.com/in/mblauberg/)
